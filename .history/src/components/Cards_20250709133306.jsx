...
export default function Cards({ stays }) {
  return (
    <div className="cardsContainer cursor-pointer md:flex md:items-center md:justify-center grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-4 md:p-6">
      {stays.map((hotel, index) => (
        <div
          key={index}
          className="overflow-hidden transition-transform duration-400 hover:scale-105 gap-2"
        >
          <img
