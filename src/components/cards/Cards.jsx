  ...
  return (
    <div>
      <div>
        ...
        <div
          id="tituloStays"
          class="flex items-center justify-between pt-4 md:mb-4 mx-12"
        >
        ...
        {stays.map((hotel, index) => (
          ...
          >
            ...
            <div className="flex items-center justify-between p-2">
              {hotel.superHost && (
                <p className="border border-gray-800 rounded-full px-2 py-1 text-xs md:text-[17px] font-bold text-gray-800">
                  Super Host
                </p>
              )}
